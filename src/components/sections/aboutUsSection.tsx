      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
        ...
        <div>
          ...
          <p className='text-gray-700 mb-6'>
            Nie jesteśmy tylko biurem nieruchomości. Jesteśmy grupą
            zaangażowanych specjalistów, którzy wspierają się nawzajem i
            stawiają na otwartą komunikację, zaufanie i partnerskie podejście.
            Dzięki temu potrafimy zbudować równie mocne relacje z naszymi
