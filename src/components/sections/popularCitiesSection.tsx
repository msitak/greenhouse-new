...
const citiesConfig: Omit<City, 'offersCount'>[] = [
  { name: 'Częstochowa', href: '/nieruchomosci?miasto=czestochowa', imageSrc: '/czestochowa.png', imageAlt: 'Częstochowa' },
  { name: 'Katowice', href: '/nieruchomosci?miasto=katowice', imageSrc: '/katowice.png', imageAlt: 'Katowice' },
  { name: 'Gliwice', href: '/nieruchomosci?miasto=gliwice', imageSrc: '/gliwice.png', imageAlt: 'Gliwice' },
];
