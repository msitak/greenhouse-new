...
const MarkerIcon = ({ color }: { color: string }) => (
    <div style={{
        ...
        transform: 'translate(-50%, -50%)' // Centruje marker nad pozycją
    }}>
    </div>
);
        ...
        <APIProvider apiKey={process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY!}>
            ...
            >
                {points.map((point) => {
                    ...
                    const color = CATEGORY_COLORS[point.category] || CATEGORY_COLORS.unknown;
                    ...
                    return (
                        <AdvancedMarker
                            ...
                            title={point.name}
                        >
                            {/* Używamy naszego niestandardowego komponentu jako ikonę */}
